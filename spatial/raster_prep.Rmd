...
wgs_ext <- raster::extent(-149.67, -149.46,-17.10,-16.92) #I have no idea if this is right Only use this when cropping, then reprojecting to albers, and then crop again using the ne_ext
...
all_ras <- mask(r, tet_shp_sp) # not working
...
r <- fasterize(tet_shp, ocean_ras, field = "rgn_id")
