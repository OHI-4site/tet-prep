...
tet_motus  <- sf::st_read(dsn = here::here('/spatial/shp'),layer = 'tet_motus_xformed', quiet = T)
...
st_write(tet_motus_final,"tet_motus_names.shp")
```

## Creating motus with vegetation information

From documents contained in the dropbox (CASUP Vegetation and Flora, tet_habitats)

```{r}

tet_motus_noinfo  <- sf::st_read(dsn = here::here('/spatial/shp'),layer = 'tet_motus_names', quiet = T)
