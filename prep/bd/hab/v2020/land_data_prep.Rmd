...
Between the report and the species profiles on the Tetiaroa Society we can see that the native ecosystem has many benefits. We therefore will use the following scheme to score each area of the motus:
