...
coral_health_fp <- read_csv(here("prep/bd/hab/v2020/_raw_data", "hab_coral_health.csv")) %>% 
  filter(rgn_id == 147)

coral_trend_fp <- read_csv(here("prep/bd/hab/v2020/_raw_data", "hab_coral_trend.csv")) %>%
  filter(rgn_id == 147)
