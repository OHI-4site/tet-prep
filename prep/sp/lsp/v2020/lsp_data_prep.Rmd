...
write.csv(land_status, file = "~/github/tet-scores/region/layers/lsp_land_status.csv")
...
write.csv(land_status, file = "~/github/tet-scores/region/layers/lsp_lagoon_status.csv")
...
write.csv(land_status, file = "~/github/tet-scores/region/layers/lsp_offshore_status.csv")
```
