...
write.csv(land_status %>% select(region_id = rgn_id, year, status), file = "~/github/tet-scores/region/layers/lsp_land_status.csv", append = FALSE)
...
write.csv(lagoon_status %>% select(region_id = rgn_id, year, status), file = "~/github/tet-scores/region/layers/lsp_lagoon_status.csv")
...
write.csv(offshore_status %>% select(region_id = rgn_id, year, status), file = "~/github/tet-scores/region/layers/lsp_offshore_status.csv", append = FALSE)
```
