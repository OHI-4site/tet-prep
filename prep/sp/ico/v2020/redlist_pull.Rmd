...
ico_spp_iucn_status <- read_csv(file.path(dir_goal, "int/tet_ico_history.csv"))
  
ico_spp_iucn_status <- rename(iucn_sid = name, year = result.year, category = result.code) #why isn't this working??
